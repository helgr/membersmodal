...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	if( $_POST['template-contactform-email'] != '' ) {
		...
		$standard = isset( $_POST['template-contactform-standard'] ) ? $_POST['template-contactform-standard'] : '';
		...
		$subject = 'WWW.COK-NIIME.RU: Новая заявка -'.' '.$name;
		...
		if( $botcheck == '' ) {
			...
			$service = isset($service) ? "Level: $service<br><br>" : '';
			$standard = isset($standard) ? "Standard: $standard<br><br>" : '';
			...
			$body = "$service $standard $name $email $phone $message $referrer";
